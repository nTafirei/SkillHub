...
<s:layout-render name="/WEB-INF/jsp/user/layout.jsp" title="Choose Role">
                        ...
                        <div id="content">
                            ...
                            <article>
                                ...
                                <table>
                                    ...
                                    <s:select name="userRole" style="background-color:#F0E68C">
                                        <s:option value=""><fmt:message
                                                key="chooserolelabel"/></s:option>
                                        <c:forEach items="${actionBean.roles}" var="otherRole"
                                                   varStatus="loopStatus">
                                            <s:option value="${otherRole.id}">
                                                ${otherRole.roleName}
                                            </s:option>
                                        </c:forEach>
                                    </s:select>

...
<s:layout-render name="/WEB-INF/jsp/user/layout.jsp" title="Showcased Innovators">
                ...
                <div id="content">
                    ...
                    <security:protected-element name="view-workers">
                        <c:if test="${empty actionBean.workers}">
                            <fmt:message key="noinnovatorsfound"/>
                        </c:if>
                        <table width="100%">
                            <tr>
                                <td align="center" colspan = "3">
                                    <c:if test="${!empty actionBean.workers}">
                                        ...
                                        <fmt:message key="innovatorsfound"/></strong>
                                    </c:if>
                                </td>
                                ...
                                <c:forEach items="${actionBean.workers}" var="worker"
                                    ...
                                    <tr valign="top" class="${loopStatus.index % 2 == 0 ? 'even' : 'odd'}">
                                        <td style="vertical-align: top; important!">
                                                ...
                                                <br/>
                                                 <d:link
                                                             href="/web/worker-publications/${worker.id}">
                                           ...
                                           <security:protected-element name="manage-workers">
                                                 | <d:link
                                                     ...
                                                     |
                                                    <d:link href="/web/innovators/${worker.id}/remove">

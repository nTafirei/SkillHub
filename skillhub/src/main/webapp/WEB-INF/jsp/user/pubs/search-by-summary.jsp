...
<s:layout-render name="/WEB-INF/jsp/user/layout.jsp" title="Search Publications By Summary">
                        ...
                        <div id="content">
                            ...
                            <article>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <th colspan="2">
                                            <h4><fmt:message key="searchpubsbysummarylabel"/></h4>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr valign="top">
                                        <td nowrap="nowrap"><fmt:message key="summarylabel"/></td>
                                        <td nowrap="nowrap">
                                            <d:textarea style="background-color:#F0E68C" name="summary"
                                            id="summary"/>
                                        </td>
                                    </tr>
                                    <tr>

...
<s:layout-render name="/WEB-INF/jsp/user/layout.jsp" title="Upload Publication">
            ...
            <div class="container">
                <div id="content">
                    ...
                    <strong><fmt:message key="uploadpublabel"/> (PDF or TEXT format only)
                        ...
                        <s:form action="/web/submit-publication" method="post" name="searchForm" id="searchForm" enctype = "multipart/form-data">

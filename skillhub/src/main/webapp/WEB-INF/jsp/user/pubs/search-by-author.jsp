...
<s:layout-render name="/WEB-INF/jsp/user/layout.jsp" title="Search Publications By Worker">
                    ...
                    <div class="8u important(collapse)">
                        <div id="content">
                            ...
                            <article>
                                ...
                                <s:form action="/web/search-publications" method="post" name="searchForm" id="searchForm">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <th colspan="2">
                                            <h4><fmt:message key="searchpubsbyworkerlabel"/></h4>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>

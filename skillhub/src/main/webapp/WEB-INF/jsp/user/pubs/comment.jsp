...
<s:layout-render name="/WEB-INF/jsp/user/layout.jsp" title="Comment on Publication">
    ...
    <s:layout-component name="contents">
        ...
        <div id="main-wrapper main-contents">
            <div class="container">
                <div id="content">
                    <s:errors/>
                    <strong>${actionBean.publication.title}<br/>
                    By: ${actionBean.publication.workerNames}
                    </strong>
                    <security:protected-element name="edit-workers">
                        ...
                        <input type="hidden" name="publication" value="${actionBean.publication.id}"/>

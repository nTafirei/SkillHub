...
import com.marotech.skillhub.action.converters.CategoryConverter;
import com.marotech.skillhub.action.converters.CityConverter;
import com.marotech.skillhub.action.converters.SkillConverter;
import com.marotech.skillhub.action.converters.SuburbConverter;
...
public class SearchActionBean extends UserBaseActionBean {
    ...
    public Resolution search() throws Exception {
        ...
        if (users == null || users.isEmpty()) {
            getContext().getValidationErrors().add("takent",
                    new LocalizableError("nomatchingtalentfound"));
            return new ForwardResolution(SEARCH_JSP);
        }
